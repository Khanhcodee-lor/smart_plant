...
class DiseaseHistoryListWidget extends StatelessWidget {
  ...
  void _askAiAboutDisease(BuildContext context, DetectionItem item) {
    final translated = translateDiseaseLabel(item.diseaseClass);
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          onTap: isHealthy ? null : () => _askAiAboutDisease(context, item),
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                // Mũi tên chỉ cho bệnh (không phải cây khỏe)
                if (!isHealthy)
                  Icon(
                    Icons.auto_awesome,
